...
>
    ...
    <div class="relative max-w-md mx-auto">
        <div class="grid grid-cols-4">
            <a href="{{ route('member.dashboard') }}" class="flex flex-col items-center justify-center py-4 gap-1 {{ request()->routeIs('member.dashboard') ? 'text-white bg-orange-500' : 'text-slate-200' }}">
            ...
            <a href="{{ route('member.events') }}" class="flex flex-col items-center justify-start py-4 gap-1 {{ request()->routeIs('member.events') || request()->routeIs('member.events*') ? 'text-white bg-orange-500' : 'text-slate-200' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="size-6">
            ...
            <a href="{{ route('member.vouchers') }}" class="flex flex-col items-center justify-end py-4 gap-1 {{ auth()->check() && auth()->user()->isMember() && request()->routeIs('member.vouchers') ? 'text-white bg-orange-500' : 'text-slate-200' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="size-6">
        ...
        <button
            ...
            class="absolute left-1/2 -top-12 -translate-x-1/2 z-50 w-16 h-16 rounded-full bg-[#3A5770]/60 text-white shadow-lg ring-4 ring-orange-500 flex items-center justify-center hover:bg-[#3A5770] active:scale-95 transition"
        >
