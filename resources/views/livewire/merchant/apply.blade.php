            ...
            @if($showSuccess)
                <div class="mb-6 bg-green-100 border border-green-400 text-green-700 px-6 py-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold">Application Submitted Successfully!</h3>
                            <p class="mt-1">Thank you for your interest. Your merchant application has been submitted and is pending admin approval. You will be notified via email once your application is reviewed.</p>
                        </div>
                    </div>
                </div>
            @else
                <div class="mb-6">
                    <h2 class="text-3xl font-bold text-gray-900">Apply to Become a Merchant</h2>
                    <p class="mt-2 text-gray-600">Fill out the form below to apply as a merchant. Your application will be reviewed by our admin team.</p>
                </div>
