    ...
    <div class="flex items-center justify-between p-4">
        <div class="w-full">
            <div class="flex flex-col items-start gap-1">
                ...
                <div class="flex flex-wrap justify-start items-center gap-3 mt-4">
                    @if($merchant->is_active)
                        <a 
                            href="{{ route('merchant.vouchers.profile', $voucher->voucher_code) }}"
                            title="View Voucher Details"
                            class="flex gap-1 items-center text-xs bg-orange-500 hover:bg-orange-600 px-2 py-1 rounded-full active:scale-95 active:bg-orange-600 md:hover:scale-110 text-white transition-all duration-200 touch-manipulation">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        ...
                        <button 
                            wire:click="edit"
                            title="Edit Voucher"
                            class="flex gap-1 items-center text-xs bg-gray-100 px-2 py-1 border border-gray-300 rounded-full active:scale-95 active:bg-sky-100 active:text-sky-600 md:hover:scale-110 md:hover:text-sky-600 cursor-pointer text-gray-600 transition-all duration-200 touch-manipulation">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        ...
                        <button 
                            ...
                            wire:click="delete"
                            class="flex gap-1 items-center text-xs bg-gray-100 px-2 py-1 border border-gray-300 rounded-full active:scale-95 active:bg-red-100 active:text-red-600 md:hover:scale-110 md:hover:text-red-600 cursor-pointer text-gray-600 transition-all duration-200 touch-manipulation">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        ...
                        <button 
                            wire:confirm="Are you sure you want to delete this voucher?" 
                            class="flex gap-1 items-center text-xs bg-gray-100 px-2 py-1 border border-gray-300 rounded-full active:scale-95 active:bg-yellow-100 active:text-yellow-700 md:hover:scale-110 md:hover:text-yellow-700 cursor-pointer text-gray-600 transition-all duration-200 touch-manipulation"
