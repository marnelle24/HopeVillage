        ...
        <div class="py-12">
            ...
            <div class="bg-white overflow-hidden shadow-md sm:rounded-lg mb-6 md:mx-0 mx-4">
                ...
                @php
                    ...
                    $inActiveColor = 'border-transparent text-gray-500';
                @endphp
                <div class="border-b border-gray-200">
                    <nav class="-mb-px flex" aria-label="Tabs">
                        <button
                            wire:click="setTab('merchant')"
                            class="{{ $tab === 'merchant' ? $activeColor : $inActiveColor }} whitespace-nowrap py-4 px-6 border-b-2 font-medium text-sm transition-colors duration-200"
                        >
                            Merchant Vouchers
                        </button>
                        <button
                ...
                <div class="p-6 md:mx-0 mx-4 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        @php
                            $searchInputDimension = $tab === 'admin' ? auth()->user()?->can('create.voucher') ? 'md:col-span-4' : 'md:col-span-5' : 'md:col-span-2';
                        @endphp

                        <div class="{{ $searchInputDimension }}">
                            <input 
                                type="text" 
