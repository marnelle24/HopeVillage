    ...
    >
        ...
        >
            <div class="w-full max-w-md bg-white rounded-t-2xl p-4" @click.stop>
                ...
                <!-- Step: menu -->
                <div x-show="qrStep === 'menu'" x-cloak>
                    <div class="grid grid-cols-1 gap-2">
                        ...
                        <button
                            type="button"
                            disabled
                            class="disabled:opacity-70 disabled:cursor-not-allowed disabled:bg-gray-200 w-full text-left px-4 py-3 rounded-xl border border-gray-400 hover:bg-gray-50"
                            @click="qrStep = 'scan'; startScan()"
                        >
                            <p class="text-sm font-semibold text-gray-400">(temporarily disabled)</p>
                            <p class="text-sm font-semibold text-gray-400">Scan a QR Code</p>
                            <p class="text-xs text-gray-400">Use your camera to scan a QR code.</p>
                        </button>
                    </div>
                </div>
