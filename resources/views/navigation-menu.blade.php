    ...
    >
        ...
        <div class="relative">
            ...
            <button
                ...
                class="absolute left-1/2 -top-7 -translate-x-1/2 z-50 w-16 h-16 rounded-full bg-slate-400/80 text-white shadow-lg ring-4 ring-slate-600 flex items-center justify-center hover:bg-slate-800 active:scale-95 transition"
            >
